...
import com.amazonaws.serverless.sample.springboot2.WebServiceConfig;
...
public class SpringBootLambdaContainerHandler<RequestType, ResponseType> extends AwsLambdaServletContainerHandler<RequestType, ResponseType, HttpServletRequest, AwsHttpServletResponse> {
    ...
    private static final String MSG_DISPATCHER_SERVLET_REGISTRATION_NAME = "messageDispatcherServlet";
    ...
    public SpringBootLambdaContainerHandler(Class<RequestType> requestTypeClass,
        ...
        log.info("Log:: Inside SpringBoot Lambda Handler");
    ...
    protected void handleRequest(HttpServletRequest containerRequest, AwsHttpServletResponse containerResponse, Context lambdaContext) throws Exception {
        ...
        log.info("Log:: Inside SpringBoot Lambda Handler - Handle Request");
        log.info("Log:: Inside SpringBoot Lambda Handler"+containerRequest.getPathInfo());
        log.info("Log:: Inside SpringBoot Lambda Handler"+containerRequest.getServletPath());
        log.info("Log:: Inside SpringBoot Lambda Handler"+containerRequest.getRequestURI());
    ...
    public void initialize()
        ...
        if (springWebApplicationType == WebApplicationType.SERVLET) {
            ...
            AwsServletRegistration reg2 = (AwsServletRegistration)getServletContext().getServletRegistration(MSG_DISPATCHER_SERVLET_REGISTRATION_NAME);
            if (reg2 != null) {
                reg2.setLoadOnStartup(1);
                log.info("Loaded Message Dispatcher servlet");
            }
        }
        super.initialize();
        initialized = true;
